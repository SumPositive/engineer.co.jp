...
本エンドユーザー使用許諾契約（以下「EULA」）は、エンジニア合同会社に所属または関係するクリエイター（以下、総称して「azukid」）によって現在提供されている、または将来提供されるアプリケーション、ソフトウェア、その関連アップグレード、パッチ、及び更新と関連サービス（以下「本製品」）を使用することをお客様に許諾します。
